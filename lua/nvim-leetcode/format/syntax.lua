...
function M.setup_solution_highlighting()
	...
	-- Set highlighting colors with fallbacks to defaults
	vim.cmd(string.format(
		"highlight LeetCodeMetadataLine guifg=%s gui=bold",
		colors.metadata_line or "#d8a657"
	))
	vim.cmd(string.format(
		"highlight LeetCodeDifficultyLine guifg=%s gui=bold",
		colors.difficulty_line or "#a9b665"
	))
	vim.cmd(string.format(
		"highlight LeetCodeTagsLine guifg=%s",
		colors.tags_line or "#7daea3"
	))
	vim.cmd(string.format(
		"highlight LeetCodeUserTagsLine guifg=%s",
		colors.user_tags_line or "#e78a4e"
	))
end

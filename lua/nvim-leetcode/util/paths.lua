...
function M.find_dependencies_dir()
  ...
  local candidates = {
    plugin_root .. "/lua/nvim-leetcode/dependencies",
    plugin_root .. "/dependencies",

    -- Common plugin manager paths
    vim.fn.stdpath("data") .. "/lazy/nvim-leetcode/lua/nvim-leetcode/dependencies",
    vim.fn.stdpath("data") .. "/lazy/nvim-leetcode/dependencies",
    vim.fn.stdpath("data") .. "/site/pack/packer/start/nvim-leetcode/lua/nvim-leetcode/dependencies",
    vim.fn.stdpath("data") .. "/site/pack/packer/start/nvim-leetcode/dependencies",

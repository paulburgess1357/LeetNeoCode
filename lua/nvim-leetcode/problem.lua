...
local vim = vim
-- Shared config and pull modules
local C = require("plugins.dummy.leetcode_dependencies.config")
local pull_meta = require("plugins.dummy.leetcode_dependencies.pull")
local pull_code = require("plugins.dummy.leetcode_dependencies.pull_code")
local pull_desc = require("plugins.dummy.leetcode_dependencies.pull_description")
-- Formatter module
local formatter = require("plugins.dummy.leetcode_dependencies.problem_formatter")
...
function M.open_problem(number)
  ...
  do
    ...
    local plugin_dir = vim.fs.dirname(this_file)
    local dep_dir = plugin_dir .. "/problem_dependencies"

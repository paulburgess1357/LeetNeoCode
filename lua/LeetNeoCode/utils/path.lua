...
-- Get cache file path
function M.get_cache_path(config)
  return config.cache_dir .. "/" .. config.cache_subdir .. "/" .. config.cache_file
end

-- Get solution directory path
function M.get_solution_dir(config)
  return config.cache_dir .. "/" .. config.solutions_subdir
end
